                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 mb-4">
                        <div class="sticky-top z-3 row gutters-10">
                            ...
                            @endphp
                            <div class="col order-1 order-md-2 tt">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto border-left ml-2 pl-2">
                                    SKU:
                                        ...
                                        @if($detailedProduct->is_wholesale==1)
                                         ...
                                         <div class="product-quantity d-flex align-items-center">
                                                 <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                                     ...
                                                     <input type="text" name="quantity" class="col  text-center flex-grow-1 fs-16 input-number-wholesale mx-2" placeholder="0" value="{{ $detailedProduct->min_variant_cost[0]->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="{{ $qty }}">
                                         ...
                                         @else
                                             <div class="product-quantity d-flex align-items-center">
                                                 <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                                     ...
                                                     <input type="text" name="quantity" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="100">
                                                     <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="plus" data-field="quantity">
                                                         <i class="las la-plus"></i>
                                                     </button>
                                                 </div>
