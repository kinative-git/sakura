...
@section('content')
    <section class="">
        {{-- <div class="container-fluid" style="padding-left:0px;padding-right:0px;">
            <div class="aiz-carousel mobile-img-auto-height dot-small-white dots-inside-bottom " data-dots="true" data-arrows="true" data-autoplay="true">
        ...
        @if(get_setting('shop_slider_images') != null)
          @if(Route::currentRouteName() == 'home.shop')
            <div class="container pt-3">
                <div class="aiz-carousel dot-small-black gutters-5 outside-arrow af-arrow" data-items="3" data-md-items="2" data-xs-items="1" data-dots="true" data-arrows="true" data-autoplay="true">
