<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    <div class="d-flex">
        <div class="aiz-topbar-nav-toggler d-flex align-items-center justify-content-start mr-2 mr-md-3 ml-0 admn" data-toggle="aiz-mobile-nav">
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            <div class="d-none d-lg-block">
                <div  class="d-flex align-items-center mt-3" style="width: 400px;">

                    <input class="form-control bg-soft-secondary border-0 form-control-sm text-dark rounded-pill d-none d-lg-block " type="text" name="" placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()"><i class="las la-search fs-16 text-dark d-none d-lg-block" style="margin-left:-1.5rem;"></i>
