<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            {{-- search bar  --}}
            <div class="px-20px mb-3 d-lg-none">
            ...
            <ul class="aiz-side-nav-list d-lg-none" id="search-menu">
            </ul>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('delivery-boys-collection-histories')}}" class="aiz-side-nav-link {{ areActiveRoutes(['delivery-boys-collection-histories'])}}">
                                <span class="aiz-side-nav-text">{{translate('Colection History')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customer.carts') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Customer Cart-list') }}</span>
                                </a>
                            </li>
                ...
                <!-- Sellers -->
                {{-- {{ dd( in_array('9', json_decode(Auth::user()->staff->role->permissions))) }} --}}
                {{-- {{ dd( get_setting('vendor_system_activation')) }} --}}
                @if((Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && get_setting('vendor_system_activation') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-file-alt aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Acitvity Logs') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('productlog.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['productlog.index', 'productlog.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Product Action Log') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('orderlog.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orderlog.index', 'orderlog.index'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Order Process Log') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
