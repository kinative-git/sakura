            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Size Guide Image')}} <small>(290x300)</small></label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="size_guide" value="{{ $product->size_guide }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
...
<!--                <div class="card">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Added For Seller')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <select class="form-control aiz-selectpicker" name="added_for" >
                                <option value="">Choose Seller</option>
                                @foreach(\App\Seller::where("verification_status", 1)->get() as $seller)
                                    <option value="{{ $seller->user->id}}" @if($product->user_id==$seller->user->id) selected @endif>
                                        {{ $seller->user->name }}
                                    </option>
                                @endforeach
                            </select>
