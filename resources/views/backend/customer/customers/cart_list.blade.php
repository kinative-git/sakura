...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3">{{translate('All Pending Carts')}}</h1>
    </div>
</div>
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th>{{translate('Added Products')}}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @foreach($customers as $key => $customer)
                        ...
                        @if ($user != null)
                            <tr>
                                ...
                                <td class="text-right">
                                    @php
                                           $product_ids=$result[$customer->user_id];
                                           $products=App\Product::whereIn('id',$product_ids)->get();
                                    @endphp

                                    @foreach ($products as $product)
                                        <div class="d-flex align-items-center">
                                            <img src="{{ uploaded_asset($product->thumbnail_img) }}" style="height: 3rem;width:3rem;" alt="">
