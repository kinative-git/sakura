...
class CategoryUtility
{
    ...
    public static function get_immediate_children($id, $with_trashed = false, $as_array = false)
    {
        ...
        $p_ids=
            Category::where('parent_id', $id)->orderBy('order_level', 'desc')->get();

        $children = $with_trashed ? $p_ids :$p_ids;
    ...
    {
        $p_ids= Category::where('parent_id', $id)->count();
        return $with_trashed ?$p_ids :$p_ids;
    }
