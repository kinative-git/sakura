    ...
    public function toArray($request)
    {
        return [
            'data' => $this->collection->map(function($data) {
                ...
                $childrenCategoryIds = \App\Utility\CategoryUtility::children_ids($data->id);
                ...
                return [
                    ...
                    'choice_options' => $this->convertToChoiceOptions(json_decode($data->choice_options),json_decode($data->colors)),
                    'colors' => json_decode($data->colors),
                    'has_discount' => homeBasePrice($data) != homeDiscountedBasePrice($data) ,
                    'discount_percent'=>(double) $discount_percent,
                    ...
                    'base_sku' => $data->stocks->first()->sku,
                    'unit' => $data->unit,
                    ...
                    'video_provide'=>$data->video_provider!=null?$data->video_provider:"",
                    'related_products'=>new ProductMiniCollection( filter_products(\App\Product::where('id', '!=', $data->id))->where('category_id', $data->category_id)->orWhereIn('category_id',$childrenCategoryIds)->orderBy('num_of_sale', 'desc')->get()
