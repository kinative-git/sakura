...
class CustomerController extends Controller
{
    ...
    public function get_carts(){
        ...
        foreach($users as $user){
            $carts=Cart::where('user_id',$user)->pluck('product_id');
            $products = array();
        ...
        $customers = Customer::whereIn('user_id', $users)->paginate(15);
        return view('backend.customer.customers.cart_list', compact( 'customers','sort_search','result'));
        // dd($result);
        // ->get();
