...
Route::get('/end-section-products', 'HomeController@end_section_products')->name('endsection.products');
...
Route::get('/customer-cart-list', 'CustomerController@get_carts')->name('customer.carts');
...
Route::post('/side-menue', 'HomeController@load_side_menue')->name('home.section.side_menue');
...
// Route::get('/category/offer/{category_slug}', 'HomeController@listingByCategory')->name('products.category');

Route::get('/category/{category_slug}/offer', 'HomeController@listingByCategory_offer')->name('products.category_offer');
