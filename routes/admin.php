...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/product_action_report', 'ProductUpdateLogController@index')->name('productlog.index');
    Route::get('/order_action_report', 'OrderUpdateLogController@index')->name('orderlog.index');
    Route::post('/order_action_report_sidebar', 'OrderUpdateLogController@show')->name('orderlog.show');
    ...
    Route::get('/sale_stat_report/print', 'ReportController@sale_report_print')->name('sale_report.print');
